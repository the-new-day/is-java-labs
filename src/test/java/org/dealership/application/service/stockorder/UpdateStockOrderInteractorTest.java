...
class UpdateStockOrderInteractorTest {
    ...
    void shouldUpdateStockOrderStatus() {
        ...
        when(stockOrderStatusMapper.toDomain(org.mockito.ArgumentMatchers.any()))
                .thenReturn(StockCarOrderStatus.APPROVED_BY_MANAGER);

        UpdateStockOrderInteractor interactor = new UpdateStockOrderInteractor(stockOrderRepository, stockOrderStatusMapper);

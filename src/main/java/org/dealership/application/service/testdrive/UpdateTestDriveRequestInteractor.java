...
public class UpdateTestDriveRequestInteractor implements UpdateTestDriveRequestUseCase {
    ...
    public UpdateTestDriveRequestInteractor(TestDriveRequestRepository testDriveRequestRepository) {
    ...
    public Response execute(Request request) {
        ...
        testDriveRequestRepository.save(TestDriveRequestMapper.mapFromDto(dto));
        return new Response();
    }
}

...
class ConfigurationTest {
    ...
    void shouldRejectUnsupportedOrFixedComponentTypes() {
        ...
        ComponentVariant unsupported = DomainTestData.variant(ComponentType.INTERIOR, modelId, BigDecimal.valueOf(100));
        assertThrows(DomainValidationException.class, () -> configuration.withVariant(unsupported));

        ComponentVariant fixed = DomainTestData.variant(ComponentType.TRANSMISSION, modelId, BigDecimal.valueOf(50));
